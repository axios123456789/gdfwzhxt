...
workOrderQueryDto.value.workOrderSource[0] = 1
...
const resetData = () => {
  handleTime.value = []
  createTime.value = []
  workOrderQueryDto.value.workOrderNo = ''
  workOrderQueryDto.value.workOrderType = []
  workOrderQueryDto.value.workOrderStatus = []
  workOrderQueryDto.value.eventType = []
  workOrderQueryDto.value.handleBeginTime = ''
  workOrderQueryDto.value.handleEndTime = ''
  workOrderQueryDto.value.acceptOrderBy = ''
  workOrderQueryDto.value.createBeginTime = ''
  workOrderQueryDto.value.createEndTime = ''
  fetchData()
}
...
.workOrderManagementDT::before {
  ...
  width: 100%;
  height: 100%;
  background-image: url('src/assets/qyc.gif');
